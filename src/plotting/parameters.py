...
def plot_A_parameters(model: GMMEOT, experiment: Experiment | None = None) -> None:
...
def plot_B_parameters(cost: BaseLSECost, starting_points: torch.Tensor, experiment: Experiment | None) -> None:
    num_subplots = 2
